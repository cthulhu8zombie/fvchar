...
class UserTest < ActiveSupport::TestCase
  ...
  test "password should have 3 of the following: UPPERCASE, D1g1ts, extr@ ch@rs, lowercase" do
    @user.password = @user.password_confirmation = 'FragrantVagrant'
    assert_not @user.valid?
  end
end